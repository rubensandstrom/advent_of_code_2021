...
fn main() {
    ...
    // I'm planning to implement this task using a stack. Every opening character will be pushed
    // and every closing character will be compared with the poped character from the stack.
    // I will also need a function to calculate total syntax error score.
